...
class TestRepeaterHandler_FootballPaths(AsyncHTTPTestCase):
    def get_app(self):
    ...
    def boilerplate(self, response, **kwargs):
        ...
        if kwargs.get('method') != 'HEAD':
            assert int(response.headers.get('Content-Length')) == kwargs.get('content_length')
    ...
    def test_HTTP_method_GET_AE_identity(self):
        response = self.fetch('/test/football.svg',
            method='GET',
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_HelpPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_PingPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_HelloWorldPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
    ...
    def test_HTTP_method_GET_AE_identity(self):
        response = self.fetch('/test/hello_world',
            method='GET',
            headers={'Accept-Encoding': 'identity'},
            )
        boilerplate = self.boilerplate(response, code=200, method='GET')
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_EndsWithJSONPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
    ...
    def test_HTTP_method_GET_AE_identity(self):
        response = self.fetch('/test/ends/with.json',
            method='GET',
            headers={
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_JSONPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
    ...
    def test_HTTP_method_GET_AE_identity(self):
        response = self.fetch('/test/accept/json.ext',
            method='GET',
            headers={
                'Accept': 'text/json',
                'Accept-Encoding': 'identity',
...
## https://www.tornadoweb.org/en/stable/testing.html
class TestRepeaterHandler_DefaultPaths(AsyncHTTPTestCase):
    def get_app(self):
        return make_app(debug=True, autoreload=False)
    ...
    def boilerplate(self, response, **kwargs):
        ...
        if kwargs.get('method') != 'HEAD':
            ...
            assert response.body.decode().find(f"> {kwargs.get('method')} /test/default/file.ext HTTP/1.1") != -1
    ...
    def test_HTTP_method_GET_AE_identity(self):
        response = self.fetch('/test/default/file.ext',
            method='GET',
            headers={'Accept-Encoding': 'identity'},
            )
        boilerplate = self.boilerplate(response, code=200, method='GET')
